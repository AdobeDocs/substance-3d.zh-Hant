...
breadcrumb-title: ''
description: 在 Unreal Engine 4 中使用 Blueprint 節點，在執行時控制 Substance 材質，實現動態材質工作流程。
...
本節詳細說明如何在 Unreal Engine 中使用 Substance 材質與 [藍圖](https://docs.unrealengine.com/en-US/Engine/Blueprints/GettingStarted/index.html) 。
