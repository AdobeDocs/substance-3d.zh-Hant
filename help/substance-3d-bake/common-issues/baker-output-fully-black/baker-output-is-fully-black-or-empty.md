---
helpx_url: "https://helpx.adobe.com/tw/substance-3d-bake/common-issues/baker-output-is-fully-black-or-empty.html"
breadcrumb-title: ''
...
> * 確認「按名稱[&#128279;](../../features/matching-by-name/matching-by-name.md)匹配」功能是否設定不當（有些物件可能彼此排除且永遠不會重疊）。
> * 確認低多邊形的紫外線是否在0-1範圍內。
